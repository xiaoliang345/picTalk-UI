...
import { getSpaceCategoryAnalyzeUsingPost, getSpaceSizeAnalyzeUsingPost, listSpaceTagAnalyzeUsingPost } from '@/api/spaceAnalyzeController'
...
async function getSpaceTagAnalyze() {
  const res = await listSpaceTagAnalyzeUsingPost({
