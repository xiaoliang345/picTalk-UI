...
export async function getDownloadUrlUsingPost(
  ...
  return request<API.BaseResponseString_>('/api/files/download-url', {
    method: 'POST',
    headers: {
...
export async function listFilesUsingGet(
  ...
  return request<API.BaseResponseListUploadVO_>(`/api/files/list/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
...
export async function uploadFileUsingPost(body: {}, file?: File, options?: { [key: string]: any }) {
  ...
  return request<API.BaseResponseUploadVO_>('/api/files/upload', {
    method: 'POST',
    data: formData,
    requestType: 'form',
    ...(options || {}),
...
export async function getUploadProgressUsingGet(
  ...
  return request<API.BaseResponseMapStringObject_>(`/api/files/upload/progress/${param0}`, {
    method: 'GET',
    params: { ...queryParams },
    ...(options || {}),
  })
